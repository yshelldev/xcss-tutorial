...
<!-- XCSS provieds a special operator called `denest`, it helps in much better organization of nested strucures. -->
<button 
...
- The second button demonstrates using the denest operator for better nested structure organization, generating variants based on nested selectors.

### Denest Operator, (destructive nesting)

The denest operator improves nesting by merging parent and child selectors using the `&` parent reference character.
How it Works
